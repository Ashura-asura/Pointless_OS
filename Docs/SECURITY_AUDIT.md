...
| Per-phase contracts | all crates | 950 total tests, 0 failures (792 kernel + 136 workspace + 22 bootloader: 13 ELF-contract + 9 fleet-CFG-contract); kernel also green at 795 with `--features vmx-demo` |
