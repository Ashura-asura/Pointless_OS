...
| Per-phase contracts | all crates | 945 total tests, 0 failures (787 kernel + 136 workspace + 22 bootloader: 13 ELF-contract + 9 fleet-CFG-contract); kernel also green at 790 with `--features vmx-demo` |
