...
| Per-phase contracts | all crates | 994 total tests, 0 failures (835 kernel + 137 workspace + 22 bootloader: 13 ELF-contract + 9 fleet-CFG-contract); kernel also green at 838 with `--features vmx-demo` |
