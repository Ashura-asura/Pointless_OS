...
| Per-phase contracts | all crates | 988 total tests, 0 failures (829 kernel + 137 workspace + 22 bootloader: 13 ELF-contract + 9 fleet-CFG-contract); kernel also green at 832 with `--features vmx-demo` |
