...
| Per-phase contracts | all crates | 1000 total tests, 0 failures (841 kernel + 137 workspace + 22 bootloader: 13 ELF-contract + 9 fleet-CFG-contract); kernel also green at 844 with `--features vmx-demo` |
