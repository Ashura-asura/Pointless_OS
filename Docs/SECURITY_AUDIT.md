...
| Per-phase contracts | all crates | 981 total tests, 0 failures (822 kernel + 137 workspace + 22 bootloader: 13 ELF-contract + 9 fleet-CFG-contract); kernel also green at 825 with `--features vmx-demo` |
