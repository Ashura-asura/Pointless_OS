...
| Per-phase contracts | all crates | 1012 total tests, 0 failures (853 kernel + 137 workspace + 22 bootloader: 13 ELF-contract + 9 fleet-CFG-contract); kernel also green at 856 with `--features vmx-demo` |
