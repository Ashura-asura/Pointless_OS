...
| Per-phase contracts | all crates | 986 total tests, 0 failures (827 kernel + 137 workspace + 22 bootloader: 13 ELF-contract + 9 fleet-CFG-contract); kernel also green at 830 with `--features vmx-demo` |
