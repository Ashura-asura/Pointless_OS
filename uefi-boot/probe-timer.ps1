...
$log = Join-Path $wd 'probe-timer.log'
Remove-Item $log -ErrorAction SilentlyContinue

$listener = Start-Process -FilePath 'python' -ArgumentList "e1000_host_listener.py", '9001', "$wd\e1000-timer.pcap" -WorkingDirectory $wd -PassThru -WindowStyle Hidden
...
Write-Output "timer: desktop=$ok preempts=$preempts input_online=$input last_tick=$ticks"