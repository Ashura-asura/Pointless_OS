...
- 356 kernel + 118 model + 13 uefi-boot tests pass clean (487 total) from a clean lockfile, clippy/rustfmt clean. The audit ring's 512-entry bound is kept honest in Known Limits (early grant records can be evicted before a late dump; ring3-side grant lines print from the supervisor).
