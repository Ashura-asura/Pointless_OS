...
Combined contract-test count across all crates: **645** (495 kernel + 128 model + 22 uefi-boot). The bare-metal CPL3 transition itself has no contract test (it needs real/virtual hardware); its proof is the live boot.
